...
async fn vault_info_returns_metadata() {
    ...
    assert!(info["name"].as_str().unwrap().ends_with("vault"));
...
async fn vault_info_scoped_to_folder() {
    ...
    let info = read_resource(&server.client, "tarn://vault/info/wiki").await;
...
async fn vault_info_scoped_to_nested_folder() {
    ...
    let info = read_resource(&server.client, "tarn://vault/info/projects/webapp").await;
...
async fn vault_info_deeply_nested() {
    ...
    let info = read_resource(&server.client, "tarn://vault/info/areas/personal/health").await;
...
async fn vault_folders_lists_all() {
    ...
    let folders = read_resource(&server.client, "tarn://vault/folders").await;
...
async fn vault_folders_scoped_to_projects() {
    ...
    let folders = read_resource(&server.client, "tarn://vault/folders/projects").await;
...
async fn vault_tags_returns_hierarchy() {
    ...
    let tags = read_resource(&server.client, "tarn://vault/tags").await;
...
async fn vault_tags_scoped_to_folder() {
    ...
    let tags = read_resource(&server.client, "tarn://vault/tags/wiki").await;
...
async fn vault_tags_scoped_to_nested_folder() {
    ...
    let tags = read_resource(&server.client, "tarn://vault/tags/projects/webapp").await;
...
async fn note_resource_nested() {
    ...
    let note = read_resource(&server.client, "tarn://note/projects/WebApp.md").await;
...
async fn note_resource_deeply_nested() {
    ...
    let note = read_resource(
        &server.client,
        "tarn://note/areas/personal/health/Fitness Plan.md",
    )
    .await;
...
async fn section_resource_reads_content() {
    ...
    let section = read_resource(&server.client, "tarn://note/wiki/Rust.md#Rust/Ownership").await;
...
async fn section_resource_nested_heading() {
    ...
    let section = read_resource(
        &server.client,
        "tarn://note/wiki/Rust.md#Rust/Ownership/Borrowing",
    )
    .await;
...
async fn section_resource_includes_tags() {
    ...
    let section = read_resource(&server.client, "tarn://note/wiki/Rust.md#Rust/Resources").await;
...
async fn section_resource_path_field_includes_fragment() {
    ...
    let section = read_resource(&server.client, "tarn://note/wiki/Rust.md#Rust/Lifetimes").await;
...
async fn lists_static_resources() {
    ...
    let resources = server.client.list_all_resources().await.unwrap();
...
async fn lists_resource_templates() {
    ...
    let templates = server.client.list_all_resource_templates().await.unwrap();
